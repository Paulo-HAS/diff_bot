...
class HybridNode:
    def __init__(self):
        ...
        rospy.Subscriber('/hokuyo2', LaserScan, self.scanCallback)
        rospy.Subscriber("/odom2", Odometry, self.odomCallback)
        self.pub_cmd_vel = rospy.Publisher('/cmd_vel2', Twist, queue_size=10)
